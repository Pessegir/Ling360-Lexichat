# -*- coding: utf-8 -*-
# LEGACY: Original 2023 course-project version. Preserved for reference only.
# DO NOT RUN — this file uses the retired OpenAI pre-1.0 API (openai.ChatCompletion.create)
# and Colab-only imports (IPython.display, !pip). The active version is lexichat_game.py.
"""Lexichat_Game.ipynb
